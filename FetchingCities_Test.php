<?php	
	...
	$soapClient = new SoapClient('TestWSDLtest.wsdl');
    $fetchingCountryCode=$_POST['_fetchingCountryCode'];
    $AnyLitterInCityName=$_POST['_AnyLitterInCityName'];
	...
	$params = array(
		...
		'CountryCode'			=> $fetchingCountryCode,

		'State'				=> NULL,

		'NameStartsWith'		=> $AnyLitterInCityName
