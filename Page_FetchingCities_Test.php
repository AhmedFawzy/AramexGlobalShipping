...
<!-- webpage content goes here in the body -->
	...
	<div id="logo">
		...
		<div id="nav">
			<ul>
				...
				<li><a href="FetchingCities_Test.zip" style="background: #3EACBA">Download Source Code</a></li>
					<li><a href="mailto:Hosam.odeh@aramex.com?subject=Error:Fetching Cities live WebService&CC=All_JED_IT@aramex.com&body=hello Dear , i am facing an aproblem in the above subjected issue , can i have your you help here ?&BCC=Hisam@aramex.com">Contact</a></li>
			</ul>	
		</div>
		<div id="content">
        
        <form action="FetchingCities_Test.php" method="POST">
    ...
    color: #fff"  >Country Information</td>
                ...
                <td> Fetching Country Code: <input type="text" name="_fetchingCountryCode" style="float: right"  value="<?php echo $name;?>"></td>
                      <td> Any Litter In City Name: <input type="text" name="_AnyLitterInCityName" style="float: right"  value="<?php echo $name;?>"></td>
        ...
        <input type="submit" value="Find Cities"class="push_button blue" style="margin-left: auto;margin-right: auto">
            </form>
