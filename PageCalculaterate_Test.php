...
<!-- webpage content goes here in the body -->
	...
	<div id="logo">
		...
		<div id="nav">
			<ul>
				...
				<li><a href="CalculateRate_test.zip" style="background: #3EACBA">Download Source Code</a></li>
                    
				<li><a href="mailto:Hosam.odeh@aramex.com?subject=Error:Calculate Rate Test WebService&CC=All_JED_IT@aramex.com&body=hello Dear , i am facing an aproblem in the above subjected issue , can i have your you help here ?&BCC=Hisam@aramex.com">Contact</a></li>
			</ul>	
		</div>
		<div id="content">
			
        <form action="CalculateRate_Test.php" method="POST">
    ...
    color: #fff"   >Shipment Information</td>
                ...
                <td>  
                      Payment Type: <select name="_PaymentType" style="float: right;width:54%" >
                        <option value="P">P</option>
                        <option value="C">C</option>
                        <option value="3">3</option>
                    </select>
                </td>
                <td>       Product Group:<select  name="_ProductGroup" style="float: right;width: 50%" >
