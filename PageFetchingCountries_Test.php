...
<!-- webpage content goes here in the body -->
		...
		<div id="nav">
			<ul>
				<li><a href="index.php">Home</a></li>
					<li><a href="fetchingCountries_test.zip" style="background: #3EACBA">Download Source Code</a></li>
					<li><a href="mailto:Hosam.odeh@aramex.com?subject=Error:Fetching Countries  WebService&CC=All_JED_IT@aramex.com&body=hello Dear , i am facing an aproblem in the above subjected issue , can i have your you help here ?&BCC=Hisam@aramex.com">Contact</a></li>
			</ul>	
		</div>
		<div id="content">

        <form action="FetchingCountries_Test.php" method="POST">
    ...
    color: #fff"   >Account Information</td></tr>
        ...
        <input type="submit" value="Find Countries" class="push_button blue" style="margin-left: auto;margin-right: auto">
